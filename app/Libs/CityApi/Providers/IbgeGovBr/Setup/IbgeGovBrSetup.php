...
namespace App\Libs\CityApi\Providers\IbgeGovBr\Setup;

use App\Libs\CityApi\Contracts\HttpSetupContract;
use Exception;

class IbgeGovBrSetup implements HttpSetupContract
{
    ...
    {
        return [
            'base_url' => config('cities-api.configs.ibge-gov-br.base_url'),
        ];
    }
